 ...
 * 1.通过代码,框架提供了一个{@link Generator}抽象类来抽象代码生成功能,现阶段只有一个实现
 * {@link ObjectiveCGenerator}<br/>
 * 2.通过浏览器下载,启动服务端的时候顺便把{@link ObjectiveCGeneratorService}
 * 注册进去,然后通过浏览器或其他Http请求下载压缩包. <br/>
 * objective-c的框架客户端源码可以从github中下载 pigeon-objc
 * 地址是:https://github.com/core-lib/pigeon-objc.git
 * 
 * @author yangchangpei
 *
 */
public class GenerationTests {
	 ...
	 */
	@Test
	public void testGenerationWithGenerator() throws Exception {
	...
	/**
	 * 启动服务,注意看到下面这个服务端不只是注册了{@link WeiboAPIImpl}这个实现类,也注册了
	 * {@link ObjectiveCGeneratorService}.通过访问这个服务就能下载想要的objc跨屏台开放接口,<br/>
	 * 试试在浏览器中敲入:http://localhost:9090/objc/generator/generate?implementation=/
	 * WeiboAPIImpl<br/>
